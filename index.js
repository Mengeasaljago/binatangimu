...
browser: ['Zyrenn Multi Device','Safari','1.0.0'],
auth: state
})
...
let pa7rick = await haikal.sendContact(callerId, global.owner)
haikal.sendMessage(callerId, { text: `Sistem otomatis block!\nJangan menelpon bot!\nSilahkan Hubungi Owner Untuk Dibuka !`}, { quoted : pa7rick })
await sleep(8000)
...
caption: he,
footer: `ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `Jangan Lupa Guyu ☺️`,
body: `ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,
